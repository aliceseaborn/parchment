...
html_theme_options = {
    'github_url': 'https://github.com/aliceseaborn/parchment',
    'use_edit_page_button': True,
    'show_toc_level': 1,
    'navbar_align': 'left',
    'logo': {
        'text': 'Parchment',
        'image_dark': 'parchment-dark.png'
    },
}

html_context = {
    'github_user': 'aliceseaborn',
    'github_repo': 'parchment',
    'github_version': 'main'
}
